      ...
      <div className="flex flex-col md:flex-row gap-16 justify-center items-center">
        {slice.items.map((item) => (
          ...
          >
            ...
            <div
              className={`p-3 h-1/4 ease-in transition-all backdrop-blur-md group-hover:backdrop-blur-lg text-white group-hover:bg-white group-hover:text-black group-hover:h-1/2 bg-[${
                item.color || "#007243"
              }]`}
            >
