...
export default function ProjectCard({
  ...
  return (
    ...
    >
      ...
      <div className={cn("p-3 h-1/4 ease-in transition-all backdrop-blur-md group-hover:backdrop-blur-lg group-hover:bg-white group-hover:text-black group-hover:h-1/2", color)}>
